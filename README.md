...
- 完整 STM32 飞控主链路：传感器采集、状态估计、速度外环（PID + 悬停推力自适应 + 高度保持）、姿态模型、力矩混控（电池电压补偿 + 非对称 PWM slew）、PWM 输出。
...
| 稳定场景 | 5/5 |
| 固定报告平均分 | 90.667/100 |
| 固定报告最弱场景 | gust_recovery = 83.316 |
| 随机验证 | 5/5 稳定，平均 88.066/100，最弱 80.953 |
| H743 stub 镜像 text | 80,744 bytes |
