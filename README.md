...
- 姿态控制器：固件内 `AdaptiveTcnPolicy`，使用 16 帧历史状态、TCN 时间核、RMA latent 自适应和分组输入归一化。
...
| 稳定场景 | 5/5 |
| 固定报告平均分 | 84.819/100 |
| 固定报告最弱场景 | gust_recovery = 79.528 |
| 随机验证 | 5/5 稳定，平均 82.402/100，最弱 73.027 |
| H743 stub 镜像 text | 71,928 bytes |
