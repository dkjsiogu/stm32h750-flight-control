...
- `../stm32h750-flight-sim/flight_control_policy_search`: 搜索姿态模型权重等价参数；当前搜索 70 维参数并导出 36-128-128-3 静态 MLP。
- `../stm32h750-flight-sim/flight_control_control_param_search`: 搜索速度外环、模型力矩缩放和 PWM 混控参数，当前闭环评估为 5/5 稳定、平均分 `89.035/100`。
